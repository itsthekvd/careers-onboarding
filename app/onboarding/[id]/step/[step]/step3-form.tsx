    ...
    <div className="bg-card rounded-lg shadow-xl p-6 sm:p-8 animate-slide-up">
      ...
      <div className="space-y-6">
        <p className="text-lg font-medium">
          You'll need to set up the following tools using your personal Gmail address:
        </p>

        <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border border-blue-100 dark:border-blue-800 my-6">
          <p className="font-medium mb-2">Important:</p>
          <p>
            Use the <span className="font-semibold">same Gmail address</span> you provided in Step 1 to sign up for all
            tools.
          </p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border">
            <div className="flex items-start space-x-3">
              <div className="flex-1">
                <h3 className="text-lg font-medium mb-2">1. TickTick</h3>
                <p className="mb-3">
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 p-3 rounded-lg border border-blue-100 dark:border-blue-800 mb-4">
                  ...
                  <p>
                    You will receive access to our TickTick workspace in the final step. For now, please create your
                    personal TickTick account.
                  </p>
                </div>
                ...
                <ol className="list-decimal pl-5 space-y-2 mb-4">
                  <li>
                    Go to{" "}
                    <a
                      href="https://ticktick.com/signup"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-blue-600 hover:underline flex items-center"
                    >
                      TickTick.com/signup <ExternalLink className="h-3 w-3 ml-1" />
                    </a>
                  </li>
                  <li>
                    Sign up using the <span className="font-semibold">same Gmail address</span> you provided in Step 1
                  </li>
                  <li>You'll receive an invitation to join our workspace in the final step</li>
                </ol>
                ...
                <ol className="list-decimal pl-5 space-y-2 mb-4">
                  ...
                  <li>Log in with the same Gmail account you used for signup</li>
                ...
                <div className="flex items-center space-x-2 mt-4">
                  ...
                  <Label htmlFor="ticktick-setup" className="text-sm font-medium">
                    I have created my TickTick account using my Gmail address
                  </Label>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border">
            <div className="flex items-start space-x-3">
              <div className="flex-1">
                <h3 className="text-lg font-medium mb-2">2. Zoho Cliq</h3>
                <p className="mb-3">
                ...
                <div className="bg-yellow-50 dark:bg-yellow-900/20 p-3 rounded-lg border border-yellow-100 dark:border-yellow-800 mb-4">
                  ...
                  <p>
                    You have already received an invitation to join Zoho Cliq via email. Please check your inbox and
                ...
                <h4 className="font-medium mt-4 mb-2">Web Setup:</h4>
                <ol className="list-decimal pl-5 space-y-2 mb-4">
                  <li>Check your email for the Zoho Cliq invitation</li>
                  <li>Click the invitation link and complete the signup process</li>
                  <li>
                    Use the <span className="font-semibold">same Gmail address</span> you provided in Step 1
                  </li>
                </ol>
                ...
                <ol className="list-decimal pl-5 space-y-2 mb-4">
                  <li>
                    ...
                    <a
                      ...
                      className="text-blue-600 hover:underline flex items-center"
                    >
                      cliq.zoho.com <ExternalLink className="h-3 w-3 ml-1" />
                    </a>
                  </li>
                  <li>
                    Press <span className="font-mono bg-gray-100 dark:bg-gray-700 px-1 rounded">Ctrl+D</span>{" "}
                ...
                <div className="flex items-center space-x-2 mt-4">
                  ...
                  <Label htmlFor="zoho-cliq-setup" className="text-sm font-medium">
                    I have accepted the Zoho Cliq invitation and set up my account
                  </Label>
                </div>
              </div>
            </div>
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border border-blue-100 dark:border-blue-800 my-6">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>You'll receive invitations to join specific projects and channels</li>
            <li>Your team lead will reach out to you via Zoho Cliq</li>
